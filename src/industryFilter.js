const RULES = [
  ...
  { industry: "병원", include: ["병원", "의원", "의료"], exclude: ["의료용품", "구급차", "동물병원", "반려동물", "장례식장", "장례"] },
  { industry: "요양병원", include: ["요양병원", "재활병원", "노인병원"], exclude: ["동물병원", "장례"] },
  { industry: "의원", include: ["의원", "내과", "정형외과", "치과", "한의원", "의료"], exclude: ["동물병원", "의료용품", "장례"] },
  ...
  { industry: "법률사무소", include: ["법률사무소", "변호사", "법률"], exclude: [] },
  { industry: "세무법인", include: ["세무법인", "세무사", "세무"], exclude: [] },
  { industry: "세무사무소", include: ["세무사무소", "세무사", "세무"], exclude: [] },
  { industry: "회계법인", include: ["회계법인", "회계사", "회계"], exclude: [] },
  { industry: "회계사무소", include: ["회계사무소", "회계사", "회계"], exclude: [] },
  { industry: "호텔", include: ["호텔", "리조트", "숙박"], exclude: ["모텔", "여관", "예식장", "웨딩홀", "결혼"] },
  { industry: "리조트펜션", include: ["리조트", "펜션", "풀빌라", "숙박"], exclude: ["모텔", "여관"] },
  ...
  { industry: "자동차 딜러", include: ["자동차", "전시장", "딜러", "수입차"], exclude: ["정비", "부품", "렌터카", "렌트카", "카셰어링"] },
  { industry: "자동차판매점", include: ["자동차", "판매", "영업소", "대리점", "전시장"], exclude: ["정비", "부품", "렌터카", "렌트카"] },
  { industry: "중고차매매", include: ["중고차", "자동차매매", "매매단지", "상사"], exclude: ["정비", "부품"] },
  ...
  { industry: "보험대리점", include: ["보험대리", "보험설계", "GA보험", "보험"], exclude: ["자동화코너"] },
  { industry: "증권자산관리", include: ["증권", "자산관리", "투자자문", "자산운용"], exclude: [] },
