...
// silently skipping it. The attempt counter is the escape hatch: a queue that can never finish
// inside one run budget would otherwise stall the whole rotation forever.
